...
Debug.AddCard(59642500,1,1,LOCATION_MZONE,3,4,true)
--Spell & Trap Zones
...
--Monster Zones
Debug.AddCard(69058960,0,0,LOCATION_MZONE,3,1,true)
Debug.AddCard(69058960,0,0,LOCATION_MZONE,3,1,true)
Debug.AddCard(69058960,0,0,LOCATION_MZONE,3,1,true)
Debug.AddCard(75878039,0,0,LOCATION_MZONE,1,1,true)
Debug.AddCard(95442074,0,0,LOCATION_MZONE,4,1,true)
Debug.AddCard(95442074,0,0,LOCATION_MZONE,4,1,true)
