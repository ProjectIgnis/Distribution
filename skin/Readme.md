...
* LPBAR_2_TOP_LEFT
* LPBAR_2_TOP_RIGHT
* PROGRESSBAR_FILL_COLOR // Changes the color for progress bar for repositories
* PROGRESSBAR_EMPTY_COLOR // Changes the color for progress bar for repositories
...
<Skin>
	...
	<Custom>
		...
		<DUELFIELD_ANNOUNCE_TEXT_BACKROUND_COLOR a="255" r="30" g="30" b="30" />
